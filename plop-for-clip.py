...
csv_path = os.path.join("results_csv", "plop_per_block.csv")
...
for branch, groups in [("vision", vision_types), ("text", text_types)]:
    ...
    # CSV export
    csv_branch = os.path.join("results_csv", f"plop_summary_{branch}.csv")
...
# 3. Plot overview
def plot_group(group_result, branch, save_dir="results_plots"):
...
def plot_per_block(per_block, branch, save_dir="results_plots"):
