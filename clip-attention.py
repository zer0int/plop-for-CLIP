...
os.makedirs("results_attention_heads", exist_ok=True)
...
# ---- Save to CSV ----
csv_path = "results_attention_heads/per_head_norms.csv"
...
cum_csv_path = "results_attention_heads/per_head_cumsum.csv"
...
plt.tight_layout()
plt.savefig("results_attention_heads/per_head_l2norm_heatmap.png")
plt.close()
...
plt.tight_layout()
plt.savefig("results_attention_heads/per_head_l2norm_lineplot.png")
plt.close()
...
plt.tight_layout()
plt.savefig("results_attention_heads/per_head_l2norm_cumsum.png")
plt.close()
